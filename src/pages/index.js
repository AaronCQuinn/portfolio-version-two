    ...
    <main className="flex items-center text-dark w-full min-h-screen">
      <Layout className="pt-0">
        ...
        <div className="w-1/2 flex justify-center">
          <motion.div className="hover: cursor-pointer" initial={{scale: 1}} whileHover={{scale: 0.95}} transition={{duration: 0.1 }} >
            <Image src={Aaron} alt="Aaron" className="rounded-lg" style={{ boxShadow: '0 6px 8px rgba(0, 0, 0, 0.7), 0 10px 16px rgba(0, 0, 0, 0.9)' }} />
          </motion.div>
        </div>
